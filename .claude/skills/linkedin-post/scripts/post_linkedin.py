...
LINKEDIN_SESSION_DIR = os.getenv("LINKEDIN_SESSION_DIR", str(VAULT / ".linkedin_session"))
    ...
    try:
        with sync_playwright() as p:
            browser = p.chromium.launch_persistent_context(
                ...
                headless=HEADLESS,          # LINKEDIN_HEADLESS=false in .env → visible window
                slow_mo=150,                # 150 ms between ops — helps Ember pick up events
